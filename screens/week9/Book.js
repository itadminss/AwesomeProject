    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <TouchableOpacity 
                ...
                style={{backgroundColor: "white",flex: 1,alignItems: "center",justifyContent: "center",width: 40,height: 40,borderRadius: 40,position: "absolute",right: 30,bottom: 30,elevation: 5,}}
                >
